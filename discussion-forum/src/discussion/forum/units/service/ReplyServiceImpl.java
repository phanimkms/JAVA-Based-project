...
public class ReplyServiceImpl implements ReplyService {
	...
	public Reply addReply(String message, Question question, User user) {
		if (Utility.isNotNullAndEmpty(message) && question != null && user != null) {
			...
			reply.setCreated();
			replies.add(reply);
			System.out.println("Reply :"+reply.getMessage()+" added");//Confirmation message that a reply has been added
			return reply;
		}
	...
	public void deleteReply(Reply reply) {
        ...
        System.out.println("Reply :"+reply.getMessage()+" deleted");//Gives a confirmation to the user that a reply has been deleted
	}
}
