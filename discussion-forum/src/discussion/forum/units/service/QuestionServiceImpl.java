...
public class QuestionServiceImpl implements QuestionService {
	...
	public Question createQuestion(String title, String message, User user) {
		if (Utility.isNotNullAndEmpty(title) && Utility.isNotNullAndEmpty(message) && user != null) {
			...
			System.out.println("Question :"+question.getMessage()+" created");//Confirmation message to user after a question is created
			return question;
		}
		System.out.println("Any specified field can't be empty");//Message displayed if any of the required fields are missing
		return null;
	}
	...
	public void deleteQuestion(Question question) {
        ...
        System.out.println("Question :"+question.getMessage()+" deleted");//Gives a confirmation to the user that a question is deleted
	}
}
